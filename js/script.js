...
function showKahala() {
  document.getElementById('kahala').style.opacity = 1;
  document.getElementById('aiea').style.opacity = 0;
}

function showAiea() {
  document.getElementById('kahala').style.opacity = 0;
  document.getElementById('aiea').style.opacity = 1;
}